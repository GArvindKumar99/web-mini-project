...
<html lang="en">
  ...
  <body>
 <p align="right">
 <img src="images/horn.gif" width="5%">
 </p>
 ...
 <nav class="navbar navbar-dark bg-primary">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
     <center>  <ul class="navbar-nav">
        ...
        <a class="nav-link disabled" href="logout.php" style="color:white;font-size:medium;">Logout</a>
     </ul></center>
  </div>
</nav>

<div style = "background-color:#FDEE33; padding:3px;"><b>Login</b></div>
<div style = "background-color:#FDEE33; padding:3px;"><b><marquee direction="corner">welcome......!!!!</marquee> </b></div>

            <div style = "margin:30px">
			

               <form action = "" method = "post">              	<img src="images/main.jpg" alian="right" width="50%">
               ...
               <div style = "font-size:11px; color:#cc0000; margin-top:10px"><?php if(isset($error))echo $error; ?></div><br><br><br><br>
